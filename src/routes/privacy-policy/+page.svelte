...
<div class="flex w-full justify-center pt-6">
    <div
        class="flex w-full max-w-2xl flex-col gap-6 break-words font-light [&_a]:underline [&_a]:underline-offset-2 [&_a]:transition-colors hover:[&_a]:text-gray-200 [&_div]:flex [&_div]:flex-col [&_div]:gap-0.5 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:tracking-wider [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:tracking-wide [&_h4]:font-semibold [&_h4]:tracking-wide"
    >
        <h1 class="text-2xl font-semibold tracking-wider">{$i18n.t("privacyPolicy")}</h1>
        ...
        {#if $i18n.resolvedLanguage !== "de"}
            ...
            <p>
                ...
                assistance, please contact me at leon@obermann-webdesign.de for more information.
            </p>
        {/if}
        ...
        <p>
            Leon Obermann<br />
            c/o IP-Management #42638<br />
            Ludwig-Erhard-Str. 18<br />
            20459 Hamburg<br />
            Deutschland
        </p>

        <p>E-Mail: leon@obermann-webdesign.de</p>
        <p>
        ...
        <p>
            ...
            einzuhalten. Weitere Informationen hierzu erhalten Sie vom Anbieter unter folgendem
            Link: <a
